...
Este archivo fue renombrado desde ``base(3).py`` para evitar problemas al
importarlo como módulo de Python. Las estructuras y comportamientos se
mantienen equivalentes al archivo original.
"""
